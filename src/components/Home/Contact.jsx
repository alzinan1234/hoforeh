      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
          <div className="mb-6 max-w-3xl text-center md:mx-auto md:mb-12">
            ...
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl">
              Get in Touch
            </h2>
            ...
            <div className="h-full pr-6">
              ...
              <ul className="space-y-6">
                ...
                <li className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">Working Hours</h3>
            ...
            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
              ...
              <form action="https://fabform.io/f/xxxxx" method="post">
                <div className="mb-6">
                  <div className="mb-4">
                    <input
                      ...
                      className="w-full mb-2 rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300"
                    />
                    <input
                      type="email"
                      id="email"
                ...
                <div className="text-center">
                  <button type="submit" className="w-full bg-blue-800 text-white px-6 py-3 rounded-md">
                    Send Message
                  </button>
                </div>
              </form>
